...
public class LearnResourceController {
    ...
    public LearnResource getLearnResourceById(@RequestParam("ResourceId")long resourceId){
        return this.learnService.queryLearnResouceById(resourceId);
    }
    ...
    public LearnResource qryLearn(@PathVariable(value = "id") Long id){
        LearnResource lean= learnService.queryLearnResouceById(id);
        return lean;
    }
}