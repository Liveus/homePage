...
public class FtpUtil {
     ...
     * @return: 若上传成功，返回
     */
    public static void pictureDownloadByConfig(FtpConfig ftpConfig, String remotePath, String fileName, String localPath) {
        boolean flag = downloadFile(ftpConfig.getFTP_ADDRESS(), Integer.parseInt(ftpConfig.getFTP_PORT()), ftpConfig.getFTP_USERNAME(), ftpConfig.getFTP_PASSWORD(), remotePath, fileName, localPath);
        if (!flag)
